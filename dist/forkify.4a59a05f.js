...
function controlPagination(page) {
    (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultPage(page)); // RENDER CURRENT PAGE
    (0, _paginationViewJsDefault.default).render(_modelJs.state.search); // RENDER PAGINATION
}
async function controlRecipes(recipe) {
    try {
        ...
        if (!recipeID) return;
        (0, _recipeViewJsDefault.default).renderSpinner(recipeContainer); // RENDER SPINNER WHILE LOADING
        (0, _resultsViewJsDefault.default).update(_modelJs.getSearchResultPage()); // Update results to mark selected recipe
        (0, _bookmarksViewJsDefault.default).update(_modelJs.state.bookmarks); // Update bookmarks
        await _modelJs.loadRecipe(recipeID); // GET RECIPE
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe); // RENDER RECIPE
    } catch (error) {
...
async function controlSearchResults() {
    try {
        ...
        const query = (0, _searchViewJsDefault.default).getQuery(); // RETURNS INPUT QUERY
        if (!query) return;
        await _modelJs.loadSearchResults(query); // LOADS THE RECIPES INTO THE STATE OBJECT
        (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultPage(1)); // RENDER CURRENT PAGE
        (0, _paginationViewJsDefault.default).render(_modelJs.state.search); // RENDER PAGINATION
    } catch (error) {
        console.log(error);
    }
...
function controlServings(newServings) {
    ...
    // Update the view
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe); // RENDER RECIPE
}
...
async function loadRecipe(recipeID) {
    try {
        const data = await (0, _helpersJs.getJSON)(`${(0, _configJs.API_URL)}${recipeID}?key=${(0, _configJs.API_KEY)}`); // LOAD RECIPE
...
async function loadSearchResults(query) {
    try {
        ...
        const { data } = await (0, _helpersJs.getJSON)(`${(0, _configJs.API_URL)}?search=${query}&key=${(0, _configJs.API_KEY)}`); // LOAD RECIPES
...
const API_KEY = `38f80afb-ef38-40af-920a-8d5eddc3ff47`;
...
class View {
    ...
    renderSpinner() {
        const markup = /* HTML */ ` <div class="spinner">
        <svg>
    ...
    renderError(message = this._errorMessage) {
        const markup = /* HTML */ ` <div class="error">
        <div>
          <svg>
    ...
    renderMessage(message = this._message) {
        const markup = /* HTML */ ` <div class="message">
        <div>
          <svg>
...
},{"url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","regenerator-runtime":"f6ot0"}],"kbE4Z":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"url:../../img/icons.svg":"fd0vu","./View.js":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./previewView.js":"6tKHS"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (currentPage === 1 && numberPages > 1) return /* HTML */ `
        <button
      ...
      `;
        // Last page
        if (currentPage === numberPages && numberPages > 1) return /* HTML */ `
        <button
          data-goto="${currentPage - 1}"
      ...
      `;
        // Other page
        if (currentPage < numberPages) return /* HTML */ `
        <button
          data-goto="${currentPage - 1}"
          class="btn--inline pagination__btn--prev"
        >
